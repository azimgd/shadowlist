...
/*
 * iOS (dark mode) design tokens for the web example. `accent` is the single
 * app tint — change this one value to re-brand every control at once.
 */
export const colors = {
  // Backgrounds
  background: '#000000',
...
/*
 * iOS type ramp. lineHeight/letterSpacing are strings so React DOM keeps the px
 * units (a bare number lineHeight would be treated as a unitless multiplier).
 */
