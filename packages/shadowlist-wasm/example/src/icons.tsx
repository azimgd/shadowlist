...
/*
 * SF-Symbol-style icons as inline SVG — no emoji, crisp at any size, tinted via
 * the `color` prop so they inherit the app accent.
 */
...
// Appearance toggle — a ring with one half filled (light/dark contrast).
