 ...
 * so the example reads like a stock iOS app. `accent` is the single app tint —
...
export const colors = {
  // Backgrounds
  background: '#000000',
  elevated: '#1C1C1E', // secondarySystemBackground
  elevated2: '#2C2C2E', // tertiarySystemBackground
  ...
  fill: 'rgba(118,118,128,0.24)', // tertiary fill, used for input fields

  // Single app tint.
  accent: '#0A84FF',
  accentSoft: 'rgba(10,132,255,0.16)', // tinted-button background
